# from https://github.com/bearpaw/pytorch-classification/blob/master/models/imagenet/resnext.py
...
def resnext50_se(baseWidth, cardinality):
    """
...
def resnext101_se(baseWidth, cardinality):
    """
...
def resnext152_se(baseWidth, cardinality):
    """
